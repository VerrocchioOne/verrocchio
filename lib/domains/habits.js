...
// getCR dual-load. Browser: utils.js sets a script-scope `getCR` global;
// we re-bind it for use inside the file scope. Node: tests require()
// this file directly, so we require utils.js explicitly.
// sortAreasByProgress lets callers inject an override via opts.getCR
// (e.g. to score on a different rate signal in tests).
let _habitsGetCR;
if (typeof require !== "undefined") {
  try { _habitsGetCR = require("../../utils.js").getCR; } catch (_) {}
}

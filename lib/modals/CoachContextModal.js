...
(function () {
  ...
  function CoachContextModal({ data, dispatch, deviceProfile, state, callbacks }) {
    ...
    return React.createElement(Dialog, {
      onHide: onClose,
      dialogProps: { "aria-label": "My Coach" },
      ...
      React.createElement("div", {
        ...
        React.createElement("div", null,
          ...
          React.createElement("div", { style: { fontFamily: "'Lora',serif", fontSize: 18, fontWeight: 700, color: "var(--c-text-strong)" } }, "Why this surfaced")
        ),
        React.createElement("button", {
          "aria-label": "Close",

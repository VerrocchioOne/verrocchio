...
(function () {
  ...
  function XpChartModal({ data, dispatch, deviceProfile, state, callbacks }) {
    ...
    return React.createElement(Dialog, {
      ...
      cardStyle: { background: "var(--c-surface, #fff)", borderRadius: "20px 20px 0 0", maxWidth: 720, maxHeight: "88vh", boxShadow: "0 -8px 40px rgba(0,0,0,.2)", display: "flex", flexDirection: "column", overflow: "hidden", padding: 0 }
    },

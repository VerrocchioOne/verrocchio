...
(function () {
  ...
  function LinkedMediaPlayerModal({ data, dispatch, deviceProfile, state, callbacks }) {
    ...
    return React.createElement(Dialog, {
      onHide: onClose,
      ariaLabelledby: "linked-media-title",
      overlayStyle: { background: "rgba(0,0,0,.55)", alignItems: "center", zIndex: 9999, padding: 16 },
      cardStyle: { background: "var(--c-surface, #fff)", borderRadius: 16, padding: 18, maxWidth: 420, boxShadow: "0 24px 60px rgba(0,0,0,.35)" }
    },

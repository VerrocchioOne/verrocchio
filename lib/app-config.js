...
// Shell version — mirrors SHELL_VERSION in service-worker.js so the
// Profile footer can display which JS bundle is running. MUST stay
// in lock-step with service-worker.js (and the sw-migration fixture
// in tests/e2e/sw-migration.spec.js); bump all three on every
// visible-to-user ship cycle.

...
function HabitsView(props) {
  ...
  // accompanying inline-source diff — see commit log for §13.4b.
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      reorderMode && (() => {
        ...
        const selHabit = selHabitId
          ? (data.habits || []).find(h => String(h.id) === String(selHabitId))
          : null;
        // For the slot picker row: find the arrayIdx of the selected
        // slot in the habit's slotSections so we can call
        // commitSlotReorderDrop with the right index. slotId encodes
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          /*#__PURE__*/React.createElement("div", {
            ...
            /*#__PURE__*/React.createElement("button", {
              ...
              disabled: !canUp,
              onClick: () => { if (canUp) moveRowWithinSection(reorderSelectedId, -1); },
            ...
            /*#__PURE__*/React.createElement("button", {
              ...
              disabled: !canDown,
              onClick: () => { if (canDown) moveRowWithinSection(reorderSelectedId, 1); },
            ...
            /*#__PURE__*/React.createElement("button", {
              ...
              disabled: !canLayer,
              onClick: () => { if (canLayer) toggleConcurrentForHabit(selHabitId); },
          ...
          // Calls commitSlotReorderDrop which rewrites slotSections[i]
          ...
          selIsSlot && /*#__PURE__*/React.createElement("div", {
            ...
            ...["morning", "afternoon", "evening"].map(sec => {
              ...
              return /*#__PURE__*/React.createElement("button", {
                ...
                onClick: () => {
                  ...
                  commitSlotReorderDrop(selHabitId, selSlotArrayIdx, sec);
    ...
    }, false && null, !showAddHabit && null, showAddHabit && /*#__PURE__*/React.createElement("div", {
      className: "fade-in",
    ...
    /*#__PURE__*/React.createElement("select", {
      ...
      value: ""
    }, "\uD83C\uDFAF Link to a Goal (optional)"), /*#__PURE__*/React.createElement("option", {
      value: "__new__"
      ...
      return /*#__PURE__*/React.createElement("optgroup", {
        key: ht.value,
        label: ht.value
      }, tg.map(g => /*#__PURE__*/React.createElement("option", {
        key: g.id,
        value: g.id
      }, g.text)));
    }), data.goals.filter(g => !g.type).length > 0 && /*#__PURE__*/React.createElement("optgroup", {
      label: "General"
    }, data.goals.filter(g => !g.type).map(g => /*#__PURE__*/React.createElement("option", {
      key: g.id,
      value: g.id
...
/*#__PURE__*/React.createElement("textarea", {
      ...
      (devProfile === "phone" ? !collapsed : true) && /*#__PURE__*/React.createElement("div", { className: "habit-grid" }, (() => {

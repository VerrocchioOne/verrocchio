  ...
  // accompanying inline-source diff — see commit log for §13.4b.
    ...
    /*#__PURE__*/React.createElement("div", {
      ...
      const renderCard = (window.HabitsHabitCard && window.HabitsHabitCard.makeRenderCard({
        ...
        rowPositionInSection, habitPositionInSection, resolveReorderDrop,
        ...
        habitClickTimerRef, swipeRef, reorderDragRef, reorderDropPreviewRef,
        ...
        setReorderDragTick, collapsedSections, setCollapsedSections,
        togHabit, moveRowWithinSection, commitHabitReorderDrop, commitSlotReorderDrop,
